...
the post fit predictions for the aggregate regions compared 
...
\clearpage
\begin{figure}[!tbhp]
    \caption{Post fit signal region predictions and data observations for the aggregate regions. 
    \label{fig:aggFitResult} }
    \includegraphics[width=2.9\cmsFigWidth]{figures/alphaT/agg_fitResults/PostfitB_stackOverlay.pdf}
\end{figure}
