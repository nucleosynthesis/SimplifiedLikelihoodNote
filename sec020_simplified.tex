...
The simplified likelihood can be used to perform a number of statistical tests using both Bayesian and frequentist techniques. For brevity, in the rest of this section, 
