...
\item{The sytstematic uncertainties in the signal can be neglected. These will strongly depend on the specific BSM physics model. 
...
background yields by setting $V_{ij}=0$ for $i\neq j$. The results subsitituing $\mathcal{L}_{S}\rightarrow\mathcal{L}$ in Equation~\ref{eq:llr}, 
